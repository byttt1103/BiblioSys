...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = [
            ...
            ['first_name' => 'lector', 'last_name' => 'lector', 'document_number' => 135791113, 'phone_number' => 3101234567, 'email' => 'byttt1103@outlook.com', 'address' => 'carrera 10 #21-49', 'password' => bcrypt('lector1234'), 'user_type' => ['reader']],
