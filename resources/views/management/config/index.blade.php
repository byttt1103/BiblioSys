    ...
    <div class="config">
        ...
        <form action="{{ route('admin.config.update') }}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" placeholder="Nombre" value="{{ old('name', $config->name ?? '') }}">
            </div>
            ...
            <div>
                ...
                <input type="text" name="address" id="address" placeholder="Dirección" value="{{ old('address', $config->address ?? '') }}">
            </div>
            ...
            <div>
                ...
                <input type="tel" name="phone_number" id="phone_number" placeholder="+57 3XX XXX XXXX" value="{{ old('phone_number', $config->phone_number ?? '') }}">
            </div>
            ...
            <div>
                ...
                <input type="email" name="email" id="email" placeholder="Correo electrónico" value="{{ old('email', $config->email ?? '') }}">
            </div>
            ...
            <div>
                ...
                <input type="time" name="opening_hour_weekday" id="opening_hour_weekday" value="{{ old('opening_hour_weekday', substr($config->opening_hour_weekday ?? '', 0, 5)) }}">
            </div>
            ...
            <div>
                ...
                <input type="time" name="closing_hour_weekday" id="closing_hour_weekday" value="{{ old('closing_hour_weekday', substr($config->closing_hour_weekday ?? '', 0, 5)) }}">
            </div>
            ...
            <div>
                ...
                <input type="time" name="opening_hour_weekend" id="opening_hour_weekend" value="{{ old('opening_hour_weekend', substr($config->opening_hour_weekend ?? '', 0, 5)) }}">
            </div>
            ...
            <div>
                ...
                <input type="time" name="closing_hour_weekend" id="closing_hour_weekend" value="{{ old('closing_hour_weekend', substr($config->closing_hour_weekend ?? '', 0, 5)) }}">
            </div>
